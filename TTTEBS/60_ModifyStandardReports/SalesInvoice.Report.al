report 50103 "TTTES Sales - Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\TTTEBS\60_ModifyStandardReports\SalesInvoiceDATA.rdl';
    // RDLCLayout = '.\TTTEBS\60_ModifyStandardReports\SalesInvoice2.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                // OnGetReferenceText("Sales Invoice Header", ReferenceText, Handled);  // TTTEBS - Issue ikke løst!


                Handled := false;
                // OnGetDocumentReferenceText("Sales Invoice Header", DocumentReference, DocumentReferenceTxt, Handled);  // TTTEBS - Issue ikke løst!
